...
from app.models import MasterResumeResponse, MasterVersion, AtomicUnit
...
async def update_atomic_unit(version_id: str, unit_id: str, unit: AtomicUnit):
    ...
    existing = await db.atomic_units.find_one({
        "id": unit_id,
        "version": version_id
    })
...
async def delete_atomic_unit(version_id: str, unit_id: str):
    ...
    result = await db.atomic_units.delete_one({
        "id": unit_id,
        "version": version_id
    })
