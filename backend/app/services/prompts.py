"""
Prompts for LLM-based resume generation.
"""
...
def generate_latex_prompt(resume_data: str) -> str:
    """
    Generate the prompt for the LLM to convert resume data to LaTeX.
    """
    return f"""You are a LaTeX expert. Convert the following structured resume information into Jake's Resume LaTeX format.
